        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                <li><a href="/main"><i class="fa fa-dashboard"></i>主页</a></li>
                    <li><a href="/content/top/show"><i class="fa fa-dashboard"></i>头部内容展示</a></li>
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">${topContent.id==0 ? "添加":"编辑"}</h3>
                        </div>
                        <form:form id="inputForm" class="form-horizontal" action="/content/top/${topContent.id==0 ? 'insert':'update'}" mothod="post"
                                   modelAttribute="topContent">
                            ...
                            <div class="box-body">
                               ...
                               <%-- <div class="form-group">
                                ...
                                <div class="box-footer">
                                    <button type="submit"
                                            class="btn btn-primary pull-right">${topContent.id == 0  ? "添加":"修改"}</button>
                                </div>
                            </div>
                        </form:form>
                    </div>
